    ...
    <div class="right_m">
        ...
        <div class="hy_list">
            ...
            <div class="search">
                ...
                <span>押金金额：</span><div class="s_text"><input name="cash" id="cash" type="text"></div>
                <button value="提交押金" id="bt-support">提交押金</button>
            </div>
            <!--查询-->
...
<script type="text/javascript">
    $("#bt-support").click(function() {
            var con = confirm("确认要提交押金吗");
            if (con == true) {
                $.ajax({
                    url: "/cash/toSupport",
                    data: "uid=" + $("#uid").val() + "&cash=" + $("#cash").val(),
                    type: "POST",
                    dataType: "json",
