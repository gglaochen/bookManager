            ...
            <form action="" method="post">
                <table cellpadding="0" cellspacing="0" class="list_hy">
                    ...
                    <#list bookBackUps as item>
                        ...
                        <td><button value="${item.bookId}" id="bt-deleteFinal" style="border: 0px">彻底删除</button></td>
                        </tr>
                    </#list>
                </table>
                <#else>
...
<script type="text/javascript">
    $("#bt-deleteFinal").click(function () {
        var con = confirm("确认要彻底删除图书吗");
        if(con==true){
        $.ajax({
            url:"/book/toDeleteFinal",
            data:"bookId="+$("#bt-deleteFinal").val(),
            type:"POST",
            dataType:"json",
